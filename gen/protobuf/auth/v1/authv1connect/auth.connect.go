...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/sena1267/cycle-note/gen/protobuf/auth/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AuthServiceSignUpProcedure = "/protobuf.auth.v1.AuthService/SignUp"
	// AuthServiceSignInProcedure is the fully-qualified name of the AuthService's SignIn RPC.
	AuthServiceSignInProcedure = "/protobuf.auth.v1.AuthService/SignIn"
)
...
// SignUp calls protobuf.auth.v1.AuthService.SignUp.
...
// SignIn calls protobuf.auth.v1.AuthService.SignIn.
...
func (UnimplementedAuthServiceHandler) SignUp(context.Context, *connect.Request[v1.SignUpRequest]) (*connect.Response[v1.SignUpResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("protobuf.auth.v1.AuthService.SignUp is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) SignIn(context.Context, *connect.Request[v1.SignInRequest]) (*connect.Response[v1.SignInResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("protobuf.auth.v1.AuthService.SignIn is not implemented"))
}
