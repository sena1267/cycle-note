...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/sena1267/cycle-note/gen/protobuf/ping/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PingServiceName = "protobuf.ping.v1.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/protobuf.ping.v1.PingService/Ping"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	pingServiceServiceDescriptor    = v1.File_protobuf_ping_v1_ping_proto.Services().ByName("PingService")
	pingServicePingMethodDescriptor = pingServiceServiceDescriptor.Methods().ByName("Ping")
)

// PingServiceClient is a client for the protobuf.ping.v1.PingService service.
type PingServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewPingServiceClient constructs a client for the protobuf.ping.v1.PingService service. By
...
// Ping calls protobuf.ping.v1.PingService.Ping.
...
// PingServiceHandler is an implementation of the protobuf.ping.v1.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/protobuf.ping.v1.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("protobuf.ping.v1.PingService.Ping is not implemented"))
}
